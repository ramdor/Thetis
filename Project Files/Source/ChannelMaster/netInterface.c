        ...
        do { // once
            ...
            if (prn != NULL) {
                ...
                prn->hsendEventHandles[0]
                    = (prn->hsendLRSem = CreateSemaphore(NULL, 0, 1, NULL));
                prn->hsendEventHandles[1]
                    = (prn->hsendIQSem = CreateSemaphore(NULL, 0, 1, NULL));
...
PORT int getUserI04_p2() {
    return (prn->user_dig_in & 0x1) != 0;
}

PORT int getUserI05_p2() {
    return (prn->user_dig_in & 0x2) != 0;
}

PORT int getUserI06_p2() {
    return (prn->user_dig_in & 0x4) != 0;
}

PORT int getUserI08_p2() {
    return (prn->user_dig_in & 0x8) != 0;
}
PORT int getUserI02_p2() {
...
// MW0LGE_22b
PORT void SetAudioAmpEnable(int enable) {
