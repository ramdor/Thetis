...
namespace Thetis
{
    unsafe partial class NetworkIO
    {
        ...
        public static extern int nativeInitMetis(String netaddr, String localaddr, int localport, int protocol, int hardware_id, int model_id, int remotePort); // MI0BOT: WAN access using different port);
