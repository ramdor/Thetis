...
namespace Thetis
{
    ...
    partial class NetworkIO
    {
        ...
        //  Dns.GetHostEntry(Dns.GetHostName()).AddressList; get a socket to send
        //  and receive on
        ...
        public static int initRadio()
        {
            ...
            if (enableStaticIP)
            {
                ...
                IPAddress targetIP;
                IPAddress hostIP;
                if (IPAddress.TryParse(EthernetHostIPAddress, out hostIP)
                    && IPAddress.TryParse(HpSdrHwIpAddress, out targetIP))
                {
    ...
    public class HPSDRDevice
    {
        ...
        public byte
            protocolSupported; // byte[12] from P2 discovery packet. MW0LGE_21d
    }
