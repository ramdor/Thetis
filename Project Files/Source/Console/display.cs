...
namespace Thetis
{
    ...
    class Display
    {
        ...
        unsafe static private bool DrawPanadapterDX2DWTF(int nVerticalShift, int W, int H, int rx, bool bottom)
        {
            if (grid_control)
            {
    ...
    int nVerticalShift, int W, int H, int rx, bool bottom)
        {
            ...
            var d2dRenderTarget = _d2dRenderTarget;
            ...
            var waterfall_bmp_dx2d = _waterfall_bmp_dx2d;
            var waterfall_bmp2_dx2d = _waterfall_bmp2_dx2d;
...
int nVerticalShift, int W, int H, int rx, bool bottom)
                ...
                if (m_bPeakBlobMaximums)
                {
                    ...
                    for (int n = 0; n < m_nNumberOfMaximums; n++)
                    {
                        if (maximums[n].Enabled)
                        {
                            ...
                            _d2dRenderTarget.DrawText(maximums[n].MaxY.ToString("f1")
                                    + " (" + (n + 1).ToString() + ")",
                                fontDX2d_callout,
        ...
        unsafe static private bool DrawWaterfallDX2D_Latest(int nVerticalShift, int W, int H, int rx, bool bottom)
        {
