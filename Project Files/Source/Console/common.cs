...
namespace Thetis
{
    ...
    public class Common
    {
        ...
        {
			Debug.Assert(String.IsNullOrEmpty(LogFilePath)); // klj. Don't do this more than once!

			LogFilePath = sPath + "ErrorLog.txt";
			LogString ("Program started.");
        ...
        public static void LogString(string entry)
        {
            ...
            if (entry == "") return;
            Debug.Assert(!String.IsNullOrEmpty(LogFilePath));
        ...
        public static void LogException(Exception e, bool showMsg = false)
        {
            // MW0LGE very simple logger
            if (m_sLogPath == "") return;
            if (e == null) return;
