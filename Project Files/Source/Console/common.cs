    ...
    public class Common
	{
        ...
        private static bool isColor(string value, out Color color)
        {
            ...
            catch
            {
                ...
                {
                    if (knownColor.ToString().Equals(value, StringComparison.OrdinalIgnoreCase))
                    {
        ...
        public static Type DetermineType(string value)
        {
            ...
            else if (isColor(value, out _))
            {
                return typeof(System.Drawing.Color);
            }
            else if (Enum.TryParse<Reading>(value, out _))
            {
                return typeof(Reading);
            }
            else if (Enum.TryParse<MeterManager.clsBarItem.BarStyle>(value, out _))
            {
                return typeof(MeterManager.clsBarItem.BarStyle);
            }
            else if (Enum.TryParse<MeterManager.clsBarItem.Units>(value, out _))
            {
                return typeof(MeterManager.clsBarItem.Units);
            }
            else if (Enum.TryParse<FontStyle>(value, out _))
            {
        ...
        //        {
        //            if (isColor(value, out Color resultColor))
        //            {
        //                return resultColor;
        //            }
        ...
        //        {
        //            if(Enum.TryParse(value, out Reading resultReading))
        //            {
        //                return resultReading;
        //            }
        //            return Enum.Parse(typeof(Reading), value);
        //        }
        //        else if (type == typeof(MeterManager.clsBarItem.BarStyle))
        //        {
        //            if (Enum.TryParse(value, out MeterManager.clsBarItem.BarStyle resultReading))
        //            {
        //                return resultReading;
        //            }
        //            return Enum.Parse(typeof(MeterManager.clsBarItem.BarStyle), value);
        //        }
        //        else if (type == typeof(MeterManager.clsBarItem.Units))
        //        {
        //            if (Enum.TryParse(value, out MeterManager.clsBarItem.Units resultReading))
        //            {
        //                return resultReading;
        //            }
        //            return Enum.Parse(typeof(MeterManager.clsBarItem.Units), value);
        //        }
        //        else if (type == typeof(FontStyle))
        //        {
        //            if (Enum.TryParse(value, out FontStyle resultReading))
        //            {
        //                return resultReading;
        //            }
        //            return Enum.Parse(typeof(FontStyle), value);
        //        }
        //        else
        //        {
        //            return value;
        ...
        //    }
        //}
        //public static object ConvertSetting(string val)
        //{
        //    Type type = Common.DetermineType(val);
        //    object typedValue = Common.ConvertToType(val, type);
        //    return typedValue;
        //}
