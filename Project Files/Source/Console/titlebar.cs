...
namespace Thetis
{
    class TitleBar
    {
        public const string BUILD_NAME = "MW0LGE pre-release, DH1KLM GUI changes";
        public const string BUILD_DATE = "(12/12/22)<FW>"; //MW0LGE_21g <FW> gets replaced in BasicTitle (console.cs) with firmware version
