...
namespace Thetis
{
    class TitleBar
    {
        public const string BUILD_NAME = "DH1KLM build";
        public const string BUILD_DATE = "(1/21/23)<FW>"; //MW0LGE_21g <FW> gets replaced in BasicTitle (console.cs) with firmware version
