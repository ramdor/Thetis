...
#region Windows Form Designer generated code
    ...
    private void InitializeComponent() {
        ...
        ((System.ComponentModel.ISupportInitialize)(this.EncoderDataGridView))
            .BeginInit();
        this.tabPage2.SuspendLayout();
        ((System.ComponentModel.ISupportInitialize)(this.ButtonDataGridView))
            .BeginInit();
        this.tabPage3.SuspendLayout();
        ((System.ComponentModel.ISupportInitialize)(this.IndicatorDataGridView))
            .BeginInit();
        this.tabPage4.SuspendLayout();
        ((System.ComponentModel.ISupportInitialize)(this.MenuDataGridView))
            .BeginInit();
        this.SuspendLayout();
        //
        // BtnClose
        ...
        this.EncoderDataGridView.ColumnHeadersHeightSizeMode
        ...
        this.EncoderDataGridView.SelectionMode
        ...
        this.ButtonDataGridView.ColumnHeadersHeightSizeMode
            = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode
                  .AutoSize;
        ...
        this.ButtonDataGridView.SelectionMode
            = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
        ...
        this.IndicatorDataGridView.ColumnHeadersHeightSizeMode
            = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode
                  .AutoSize;
        ...
        this.IndicatorDataGridView.SelectionMode
            = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
        ...
        this.MenuDataGridView.ColumnHeadersHeightSizeMode
            = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode
                  .AutoSize;
        ...
        this.MenuDataGridView.CellValueChanged
            += new System.Windows.Forms.DataGridViewCellEventHandler(
                this.MenuDataGridView_CellValueChanged);
        //
        // btnDelete
        //
        ...
        this.Activated
            += new System.EventHandler(this.AndromedaEditForm_Activated);
        this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(
            this.AndromedaEditForm_FormClosing);
...
#region Event Handlers
    ...
    private void AndromedaEditForm_FormClosing(
    ...
    private void AndromedaEditForm_Activated(object sender, EventArgs e) {
        ...
        if (!FormInitialised) {
            ...
            DataGridViewComboBoxColumn ColumnEncoderAction
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Encoder Action",
                      HeaderText = "Encoder Action", Width = 200,
                      DataSource = StringData.Tables["Encoder Combo Strings"],
                      ValueMember = "ActionId", DisplayMember = "ActionString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            EncoderDataGridView.Columns.Add(ColumnEncoderAction);

            DataGridViewComboBoxColumn ColumnEncoderRXOverride
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Encoder RX Selector",
                      HeaderText = "Selected RX", Width = 160,
                      DataSource
                      = StringData.Tables["Encoder RX Override Strings"],
                      ValueMember = "OvrId", DisplayMember = "OvrString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            ...
            DataGridViewComboBoxColumn ColumnButtonAction
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Pushbutton Action",
                      HeaderText = "Pushbutton Action", Width = 240,
                      DataSource
                      = StringData.Tables["Pushbutton Combo Strings"],
                      ValueMember = "ActionId", DisplayMember = "ActionString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            ButtonDataGridView.Columns.Add(ColumnButtonAction);

            DataGridViewComboBoxColumn ColumnButtonRXOverride
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Pushbutton RX Selector",
                      HeaderText = "Selected RX", Width = 160,
                      DataSource
                      = StringData.Tables
                        ["Pushbutton RX Override Strings"], // reused the same
                                                            // table
                      ValueMember = "OvrId", DisplayMember = "OvrString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            ...
            DataGridViewComboBoxColumn ColumnIndicatorAction
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Indicator Action",
                      HeaderText = "Indicators shows:", Width = 200,
                      DataSource = StringData.Tables["Indicator Combo Strings"],
                      ValueMember = "ActionId", DisplayMember = "ActionString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            IndicatorDataGridView.Columns.Add(ColumnIndicatorAction);

            DataGridViewComboBoxColumn ColumnIndicatorRXOverride
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Indicator RX Selector",
                      HeaderText = "Selected RX", Width = 200,
                      DataSource
                      = StringData.Tables["Indicator RX Override Strings"],
                      ValueMember = "OvrId", DisplayMember = "OvrString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            ...
            DataGridViewComboBoxColumn ColumnMenuAction
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Menu Action",
                      HeaderText = "Menu button action", Width = 250,
                      DataSource
                      = StringData.Tables["Pushbutton Combo Strings"],
                      ValueMember = "ActionId", DisplayMember = "ActionString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            ...
            DataGridViewTextBoxColumn ColumnMenuText
                = new DataGridViewTextBoxColumn { DataPropertyName
                      = "Menu Text",
                      HeaderText = "Button Text:", Width = 220 };
            MenuDataGridView.Columns.Add(ColumnMenuText);

            DataGridViewComboBoxColumn ColumnMenuRXOverride
                = new DataGridViewComboBoxColumn { DataPropertyName
                      = "Menu RX Selector",
                      HeaderText = "Selected RX", Width = 120,
                      DataSource
                      = StringData
                            .Tables["Encoder RX Override Strings"], // reused
                                                                    // the same
                                                                    // table
                      ValueMember = "OvrId", DisplayMember = "OvrString",
                      DisplayStyle = DataGridViewComboBoxDisplayStyle.Nothing };
            ...
            DataGridViewTextBoxColumn ColumnMenuLink
                = new DataGridViewTextBoxColumn { DataPropertyName
                      = "Menu Number",
                      HeaderText = "Link to Menu:", Width = 80 };
    ...
    // this displays the row numbers in the row headers to show
    // encoder/button/indicator number
    ...
    // function to select an encoder row. Used to allow an encoder turn to
    // highlight its data. parameter is encoder number (0-19)
    ...
    // function to select a pushbutton row. Used to allow a button press to
    // highlight its data. parameter is button number (0-49)
    ...
    // I don't know why but we have to set the row numbers when the tab is
    // selected
    ...
    private void btnDelete_Click(object sender, EventArgs e) {
        ...
        for (Cntr = 0; Cntr < CellCount; Cntr++) {
            ...
            if (MenuLink > NewMenuCount)
                UserData.Tables[4].Rows[Cntr]["Menu Number"]
                    = 1; // if pointing past end of menus
            else if (MenuLink > MenuNumber)
                UserData.Tables[4].Rows[Cntr]["Menu Number"]
                    = MenuLink - 1; // if past where we deleted, decrement
        }
    ...
    private void MenuDataGridView_CellValueChanged(
        object sender, DataGridViewCellEventArgs e) {
        int Row;
        int MenuEnumValue;
        int Column = e.ColumnIndex;
        // int CombooValuesRow;                    // row number in the combo
        // box possible values
        ...
        if (Column == 0) {
            ...
            ComboValuesCount
                = StringData.Tables["Pushbutton Combo Strings"].Rows.Count;
            for (Cntr = 0; Cntr < ComboValuesCount; Cntr++) {
                if ((int)StringData.Tables["Pushbutton Combo Strings"]
                        .Rows[Cntr]["ActionId"]
                    == MenuEnumValue)
                    UserData.Tables[4].Rows[Row]["Menu Text"]
                        = StringData.Tables["Pushbutton Combo Strings"]
                              .Rows[Cntr]["MenuText"];
            }
        }
    ...
    // if inserting at the end, simply add new rows; otherwise they will need to
    // be inserted
    private void BtnInsert_Click(object sender, EventArgs e) {
        ...
        int Cntr;
        // int CellCount;                      // number of rows in table
        // int NewMenuCount;                      // number of menus after
        // delete
        int MenuLink;
        int CurrentRowCount;
        DataRow NewRow;
        ...
        MenuNumber = (Index / 8) + 1;
        StartRow = (MenuNumber - 1) * 8;
        if (Index - StartRow >= 4) StartRow += 8;
        ...
        if (StartRow < CurrentRowCount) {
            ...
            for (Cntr = 0; Cntr < CurrentRowCount; Cntr++) {
                MenuLink = (int)UserData.Tables[4].Rows[Cntr]["Menu Number"];
                if (MenuLink
                    >= MenuNumber) // if pact the end, link back to start menu
                    UserData.Tables[4].Rows[Cntr]["Menu Number"] = MenuLink + 1;
            }
        } else {
            UserData.Tables[4].Rows.Add(
                0, 0, "----", 0, 0); // numerical paramter only for "menu"
                                     // entries - points to next
