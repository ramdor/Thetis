...
//  xtype:  0 - fourth power transition; 1 - raised cosine transition; 2 - brick
//  wall xbw:  width of raised cosine transition
{
...
double* cfir_impulse(int N, int DD, int R, int Pairs, double runrate,
    ...
    // 4th-power rolloff, 1 for raised cosine, 2 for brick wall xbw:
    // transition bandwidth for raised cosine rtype:	0 for real output, 1 for
    // complex output scale:	scale factor to be applied to the output
    int i, j;
...
PORT void SetTXACFIRNC(int channel, int nc) {
