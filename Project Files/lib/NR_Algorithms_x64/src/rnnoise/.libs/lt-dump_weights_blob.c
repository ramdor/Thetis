...
/* ./.libs/lt-dump_weights_blob.c - temporary wrapper executable for .libs/dump_weights_blob.exe
   Generated by libtool (GNU libtool) 2.5.4

   The dump_weights_blob program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dump_weights_blob.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# dump_weights_blob - temporary wrapper script for .libs/dump_weights_blob.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The dump_weights_blob program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"dump_weights_blob.exe:dump_weights_blob:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dump_weights_blob.exe:dump_weights_blob:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dump_weights_blob.exe:dump_weights_blob:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='dump_weights_blob.exe'\n", f);
