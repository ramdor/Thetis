...
/* ./.libs/lt-dump_features.c - temporary wrapper executable for .libs/dump_features.exe
   Generated by libtool (GNU libtool) 2.5.4

   The dump_features program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dump_features.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# dump_features - temporary wrapper script for .libs/dump_features.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The dump_features program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"dump_features.exe:dump_features:$LINENO: libtool wrapper (GNU libtool", f);
  fputs (") 2.5.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dump_features.exe:dump_features:$LINENO: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dump_features.exe:dump_features:$LINENO: newargv[0]: $progdir\\\\$", f);
  fputs ("program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='dump_features.exe'\n", f);
