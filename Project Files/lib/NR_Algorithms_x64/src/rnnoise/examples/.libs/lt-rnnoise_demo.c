...
/* examples/.libs/lt-rnnoise_demo.c - temporary wrapper executable for .libs/rnnoise_demo.exe
   Generated by libtool (GNU libtool) 2.5.4

   The examples/rnnoise_demo program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\TestBuild\\msys64\\home\\Richie\\rnnoise\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\TestBuild\\msys64\\home\\Richie\\rnnoise\\.libs;D:\\TestBuild\\msys64\\mingw64\\lib;D:\\TestBuild\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "rnnoise_demo.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/rnnoise_demo - temporary wrapper script for .libs/rnnoise_demo.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/rnnoise_demo program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("  notinst_deplibs=' librnnoise.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"rnnoise_demo.exe:examples/rnnoise_demo:$LINENO: libtool wrapper (GNU ", f);
  fputs ("libtool) 2.5.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"rnnoise_demo.exe:examples/rnnoise_demo:$LINENO: newargv[$lt_dump_arg", f);
  fputs ("s_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"rnnoise_demo.exe:examples/rnnoise_demo:$LINENO: newargv[0]: $pro", f);
  fputs ("gdir\\\\$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='rnnoise_demo.exe'\n", f);
  ...
  fputs ("    PATH=/home/Richie/rnnoise/.libs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/Richie/rnnoise/.libs:$PATH\"\n", f);
  fputs ("\n", f);
