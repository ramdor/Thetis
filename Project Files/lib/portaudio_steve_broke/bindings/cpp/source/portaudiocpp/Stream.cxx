...
bool Stream::isStopped() const {
    ...
    if (ret < 0) throw PaException(ret);
...
//////
/// Returns the best known input latency for the Stream. This value may differ
/// from the suggested input latency set in the StreamParameters. Includes all
/// sources of latency known to PortAudio such as internal buffering, and Host
/// API reported latency. Doesn't include any estimates of unknown latency.
//////
...
//////
/// Returns the best known output latency for the Stream. This value may differ
/// from the suggested output latency set in the StreamParameters. Includes all
/// sources of latency known to PortAudio such as internal buffering, and Host
/// API reported latency. Doesn't include any estimates of unknown latency.
//////
...
/// pointer should not be needed as PortAudioCpp aims to provide all of
/// PortAudio's functionality.
//////
...
//////
/// Accessor (non-const) for PortAudio PaStream pointer, useful for interfacing
/// with PortAudio add-ons such as PortMixer for instance. Normally accessing
/// this pointer should not be needed as PortAudioCpp aims to provide all of
/// PortAudio's functionality.
//////
